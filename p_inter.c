  ...
  mobj_t*	toucher )
{
	...
	// weapons
      ...
      case SPR_MGUN:
		if (!P_GiveWeapon (player, wp_chaingun, special->flags&MF_DROPPED ? true : false) )
			return;
      ...
      case SPR_SHOT:
		if (!P_GiveWeapon (player, wp_shotgun, special->flags&MF_DROPPED ? true : false) )
			return;
      ...
      case SPR_SGN2:
		if (!P_GiveWeapon (player, wp_supershotgun, special->flags&MF_DROPPED ? true : false) )
			return;
